    ...
    <header className="h-max transition-all delay-500 sticky top-0 z-10 w-full text-center bg-black bg-opacity-80">
      ...
      <div className="flex flex-col items-center gap-2 pb-2">
        ...
        <div className="flex justify-center gap-2">
          <Button variant="outline" className="b2 animate-pulse" onClick={onRefresh}>
            Refresh
          </Button>
          <select
            className="b2 bg-transparent text-white border-white border-opacity-50 rounded px-2"
            value={filter}
          ...
          <Button variant="outline" className="b2 animate-pulse">
            <Link href="/settings" className="text-white hover:underline hover:animate-pulse">
              Settings
            </Link>
          </Button>
